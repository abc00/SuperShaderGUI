...
const int
    ...
    DATA_BACKGROUND_BRIGHTNESS          = 5,
    DATA_BACKGROUND_SCALE               = 6,
    DATA_WINDOW_IMAGE_CONTROL           = 7,
    DATA_IMAGE_BRIGHTNESS               = 8,
    DATA_WINDOW_IMAGEA                  = 9,
    DATA_WINDOW_IMAGEB                  = 10,
    DATA_BUTTONA                        = 11,
    DATA_BG_COLOR                       = 12,
    DATA_IMAGE_COLOR                    = 13,
    DATA_WINDOW_EDIT_COLOR              = 14,
    DATA_EDIT_WHICH_COLOR               = 15,
    DATA_SCROLLBAR_PANEL                = 16;
    
const int
    IDC_CHECKBOX_SHOW_IMAGE             = 0,
    IDC_WINDOW_CONTROLS                 = 1,
    IDC_CHECKBOX_BACKGROUND_IMAGE       = 2,
    IDC_SLIDER_BACKGROUND_BRIGHTNESS    = 4,
    IDC_SLIDER_BACKGROUND_SCALE         = 5,
    IDC_WINDOW_IMAGE_CONTROL            = 6,
    IDC_SLIDER_IMAGE_BRIGHTNESS         = 7,
    IDC_WINDOW_IMAGEA                   = 8,
    IDC_WINDOW_IMAGEB                   = 9,
    IDC_BUTTONA                         = 10,
    IDC_BUTTONB                         = 11,
